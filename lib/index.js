...
YandexCheckout.prototype = {
   ...
   * @returns {Promise<Object>}
   */
  _createRefund: function(paymentId, amount, description, idempotenceKey) {
   ...
   * }
   */
  createRefund: function(paymentId, amount, description, idempotenceKey) {
    var _self = this;
    return this._createRefund(paymentId, amount, description, idempotenceKey).then(function(data) {
